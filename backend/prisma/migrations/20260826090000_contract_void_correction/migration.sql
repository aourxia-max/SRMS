ALTER TABLE `file_assets`
  MODIFY `category` ENUM('TENANT_ID','CONTRACT','CONTRACT_VOID_PROOF','PAYMENT_PROOF','DEPOSIT_REFUND_PROOF','PRICING_REBATE_PROOF','IMPORT','EXPORT','BACKUP','FINANCE_EXPORT') NOT NULL;
