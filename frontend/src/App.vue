...
const propertyAffairRouteNames = new Set(['property-affairs', 'property-affair-create', 'property-affairs-recycle-bin', 'property-affair-detail', 'property-affair-edit'])
  ...
  <div v-else class="srms-shell" :class="{ 'is-collapsed': collapsed }">
    <aside class="srms-sidebar">
      ...
      <nav class="srms-nav">
        ...
        <router-link v-if="isAdmin" data-test="property-affairs-sidebar" to="/property-affairs" class="srms-nav-item" :class="{ 'section-active': propertyAffairsSectionActive }"><span>◇</span><b v-show="!collapsed">物业办事</b></router-link>
